...
public class AlgorithmsPrinceton {
    ...
    public static void main(String[] args) {
        ...
        try {
            BufferedReader br = new BufferedReader(new FileReader(new File("/home/christian/coursera/Algorithms_Part_I_Princeton/Programming Assigment 1/percolation/input50.txt")), 1);
